...
namespace CJJ.Blog.NetWork.WcfHelper
{
    ...
    public class BlogHelper
    {
        ...
        /// <param name="limit">The limit.</param>
        /// <returns>System.Collections.Generic.List&lt;FastDev.Service.Models.Data.Sys_menu&gt;.</returns>
        public static List<Access> GetListPage_Access(int page = 1, int limit = 10, Dictionary<string, object> dicwhere = null)
        {
            return Client.GetListPage_Access(page, limit, dicwhere);
        }
        ...
        /// <param name="dicwhere">查询条件</param>
        /// <returns></returns>
        public static FastJsonResult<List<Access>> GetJsonListPage_Access(int page = 1, int limit = 10, string orderby = "", Dictionary<string, object> dicwhere = null)
        {
            return Client.GetJsonListPage_Access(page, limit, orderby, dicwhere);
        }
        ...
        /// </summary>
        /// <returns>List&lt;Sys_role&gt;.</returns>
        public static List<Access> GetAllList_Access()
        {
            return Client.GetAllList_Access();
        }
        ...
        /// <param name="dicwhere">查询条件 字段名可以增加|b |s |l 等作为搜索条件</param>
        /// <returns>List&lt;Sys_role&gt;.</returns>
        public static List<Access> GetList_Access(Dictionary<string, object> dicwhere)
        {
            return Client.GetList_Access(dicwhere);
        }
        ...
        /// </summary>
        /// <returns>System.Int32.</returns>
        public static int GetCount_Access(Dictionary<string, object> dicwhere = null)
        {
            return Client.GetCount_Access(dicwhere);
        }
        ...
        /// <param name="kID">The k identifier.</param>
        /// <returns>System.Int32.</returns>
        public static Access GetModelByKID_Access(int kID)
        {
            return Client.GetModelByKID_Access(kID);
        }
        ...
        /// <param name="kID">The k identifier.</param>
        /// <returns>System.Int32.</returns>
        public static Access GetModelByWhere_Access(Dictionary<string, object> dicwhere)
        {
            return Client.GetModelByWhere_Access(dicwhere);
        }
        ...
        /// <param name="dicwhere">条件查询</param>
        /// <returns></returns>
        public static DataTable GetDataTable_Access(Dictionary<string, object> dicwhere, int page = 1, int limit = 10)
        {
            return Client.GetDataTable_Access(dicwhere, page, limit);
        }
        ...
        /// <param name="limit">当前页显示的数据条数</param>
        /// <returns></returns>
        public static List<Access> GetListByInSelect_Access(string subTableName, string mainTableFields, string subTableFields, Dictionary<string, object> mainDicWhere, Dictionary<string, object> subDicWhere, int page = 1, int limit = 10)
        {
            return Client.GetListByInSelect_Access(subTableName, mainTableFields, subTableFields, mainDicWhere, subDicWhere, page, limit);
        }
        ...
        /// <param name="subDicWhere">子表的Where条件</param>
        /// <returns></returns>
        public static int GetCountByInSelect_Access(string subTableName, string mainTableFields, string subTableFields, Dictionary<string, object> mainDicWhere, Dictionary<string, object> subDicWhere)
        {
            return Client.GetCountByInSelect_Access(subTableName, mainTableFields, subTableFields, mainDicWhere, subDicWhere);
        }
        ...
        /// <param name="limit">当前条数</param>
        /// <returns></returns>
        public static DataTable GetDataByGroup_Access(List<string> groupByFields, Dictionary<string, object> dicWhere, int page = 1, int limit = 10)
        {
            return Client.GetDataByGroup_Access(groupByFields, dicWhere, page, limit);
        }
        ...
        /// <param name="opertionUser">操作者信息</param>
        /// <returns>Result.</returns>
        public static Result Add_Access(Dictionary<string, object> dicdata, OpertionUser opertionUser)
        {
            return Client.Add_Access(dicdata, opertionUser);
        }
        ...
        /// <param name="opertionUser">操作者信息</param>
        /// <returns>Result.</returns>
        public static Result Adds_Access(List<Dictionary<string, object>> dicdata, OpertionUser opertionUser)
        {
            return Client.Adds_Access(dicdata, opertionUser);
        }
        ...
        /// <param name="opertionUser">操作者信息</param>
        /// <returns>Result.</returns>
        public static Result AddByEntity_Access(Access entity, OpertionUser opertionUser)
        {
            return Client.AddByEntity_Access(entity, opertionUser);
        }
        ...
        /// <param name="opertionUser">操作者信息</param>
        /// <returns>Result.</returns>
        public static Result AddByEntitys_Access(List<Access> entitys, OpertionUser opertionUser)
        {
            return Client.AddByEntitys_Access(entitys, opertionUser);
        }
        #endregion
        ...
        /// <param name="opertionUser">操作者信息</param>
        /// <returns>Result.</returns>
        public static Result Update_Access(Dictionary<string, object> dicdata, int kID, OpertionUser opertionUser)
        {
            return Client.Update_Access(dicdata, kID, opertionUser);
        }
        ...
        /// <param name="opertionUser">操作者信息</param>
        /// <returns>Result.</returns>
        public static Result UpdateByWhere_Access(Dictionary<string, object> valuedata, Dictionary<string, object> keydata, OpertionUser opertionUser)
        {
            return Client.UpdateByWhere_Access(valuedata, keydata, opertionUser);
        }
        ...
        /// <param name="opertionUser">操作者信息</param>
        /// <returns></returns>
        public static Result UpdateNums_Access(string fields, int addNums, Dictionary<string, object> whereKey, OpertionUser opertionUser)
        {
            return Client.UpdateNums_Access(fields, addNums, whereKey, opertionUser);
        }
        ...
        /// <param name="opertionUser">操作者信息</param>
        /// <returns>Result.</returns>
        public static Result Delete_Access(string kid, OpertionUser opertionUser)
        {
            return Client.Delete_Access(kid, opertionUser);
        }
        ...
        /// <param name="opertionUser">操作者信息</param>
        /// <returns>Result.</returns>
        public static Result DeleteByWhere_Access(Dictionary<string, object> keydata, OpertionUser opertionUser)
        {
            return Client.DeleteByWhere_Access(keydata, opertionUser);
        }
        #endregion
        ...
        /// <param name="opertionUser">操作者信息</param>
        /// <returns>Result.</returns>
        public static Result ExportExcelFile_Access(Dictionary<string, object> keydata, string fileFullName, OpertionUser opertionUser)
        {
            return Client.ExportExcelFile_Access(keydata, fileFullName, opertionUser);
        }
        #endregion
