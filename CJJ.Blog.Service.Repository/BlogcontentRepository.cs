...
namespace CJJ.Blog.Service.Repository
{
	...
	public class BlogcontentRepository : BaseQuery
    {
        /// <summary>
        /// 单利实体操作对象
        /// </summary>
        public static BlogcontentRepository Instance = new BlogcontentRepository();
        ...
        public BlogcontentRepository(DBOperator dbConn)
        {
