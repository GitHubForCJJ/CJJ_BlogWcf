...
namespace CJJ.Blog.Service.Repository
{
	...
	public class WxUserRepository : BaseQuery
    {
        /// <summary>
        /// 单利实体操作对象
        /// </summary>
        public static WxUserRepository Instance = new WxUserRepository();
        ...
        public WxUserRepository(DBOperator dbConn)
        {
