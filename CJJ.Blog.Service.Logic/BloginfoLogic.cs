...
namespace CJJ.Blog.Service.Logic
{
    ...
    public class BloginfoLogic
    {
        ...
        public static List<Bloginfo> GetListPage(int page = 1, int limit = 10, Dictionary<string, object> dicwhere = null)
        {
            string orderby = "";
            ...
            return BloginfoRepository.Instance.GetListPage<Bloginfo>(limit, page, dicwhere, orderby).ToList();
        }
